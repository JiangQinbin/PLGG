...
/**
 * Servlet implementation class EndOrderServlet
 */
@WebServlet("/EndOrderServlet")
public class EndOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    list=orderDAO.select6(username);
	    String div="";
	    if(list.size()>0){
	    	int n =list.size();
	    	for(int i = 0; i < n ;i++ ){
	    	 ...
	    	 div="<hr><span class='ziti'>暂没有已收货订单信息！</span>";
	    }
	    out.print(div);
	    out.close();
	}
