    ...
    if (obj) { 
        ...
        //firefox浏览器兼容 
            ...
            if (obj.files) { 
                ...
                alert(window.URL.createObjectURL(obj.files.item(0)));
                return; 
            } 
...
function addGoods(numberof) {
	...
	else if(ntitle<2||ntitle>30||nintroduce<15||nintroduce>50||weight1==""||weight2==""||price1==""||price2==""||price3==""||price4==""){
	...
	<div class="top2">
		...
		<div class="bottom">
			<input class="bottombutton" type="button" value="发布" name="button1"
				id="button1ID" onclick="addGoods(5)"> <span
